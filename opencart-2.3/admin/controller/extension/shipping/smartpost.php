...
class ControllerExtensionShippingSmartpost extends Controller {
	...
	public function index() {
		$data = array();
		$data = array_merge($data,$this->load->language('extension/shipping/smartpost'));
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/shipping/smartpost', 'token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('extension/shipping/smartpost', 'token=' . $this->session->data['token'], true);
