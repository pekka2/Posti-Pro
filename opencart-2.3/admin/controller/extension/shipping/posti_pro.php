...
class ControllerExtensionShippingPostiPro extends Controller {
	...
	public function index() {
		$data = array();
		$data = array_merge($data,$this->load->language('extension/shipping/posti_pro'));
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/shipping/posti_pro', 'token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('extension/shipping/posti_pro', 'token=' . $this->session->data['token'], true);
