<?php
class ControllerExtensionShippingPostiPro extends Controller {
	private $error = array();
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			$this->model_setting_setting->editSetting('shipping_posti_pro', $this->request->post);
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/shipping/posti_pro', 'user_token=' . $this->session->data['user_token'], true)
		);

		$data['action'] = $this->url->link('extension/shipping/posti_pro', 'user_token=' . $this->session->data['user_token'], true);
		$data['cancel'] = $this->url->link('marketplace/extension', 'user_token=' . $this->session->data['user_token'] . '&type=shipping', true);


		if (isset($this->request->post['shipping_posti_pro_status'])) {
			$data['shipping_posti_pro_status'] = $this->request->post['shipping_posti_pro_status'];
		} else {
			$data['shipping_posti_pro_status'] = $this->config->get('shipping_posti_pro_status');
		}

		if (isset($this->request->post['shipping_posti_pro_kotijakelu_status'])) {
			$data['shipping_posti_pro_kotijakelu_status'] = $this->request->post['shipping_posti_pro_kotijakelu_status'];
		} else {
			$data['shipping_posti_pro_kotijakelu_status'] = $this->config->get('shipping_posti_pro_kotijakelu_status');
		}

		if (isset($this->request->post['shipping_posti_pro_kotijakelu_price'])) {
			$data['shipping_posti_pro_kotijakelu_price'] = $this->request->post['shipping_posti_pro_kotijakelu_price'];
		} else {
			$data['shipping_posti_pro_kotijakelu_price'] = $this->config->get('shipping_posti_pro_kotijakelu_price');
		}

		if (isset($this->request->post['shipping_posti_pro_top'])) {
			$data['shipping_posti_pro_top'] = $this->request->post['shipping_posti_pro_top'];
		} else {
			$data['shipping_posti_pro_top'] = $this->config->get('shipping_posti_pro_top');
		}

		if (isset($this->request->post['shipping_posti_pro_sort_order'])) {
			$data['shipping_posti_pro_sort_order'] = $this->request->post['shipping_posti_pro_sort_order'];
		} else {
			$data['shipping_posti_pro_sort_order'] = $this->config->get('shipping_posti_pro_sort_order');
		}

		if (isset($this->request->post['shipping_posti_pro_weight_class_id'])) {
			$data['shipping_posti_pro_weight_class_id'] = $this->request->post['shipping_posti_pro_weight_class_id'];
		} else {
			$data['shipping_posti_pro_weight_class_id'] = $this->config->get('shipping_posti_pro_weight_class_id');
		}

		if (isset($this->request->post['shipping_posti_pro_length_class_id'])) {
			$data['shipping_posti_pro_length_class_id'] = $this->request->post['shipping_posti_pro_length_class_id'];
		} else {
			$data['shipping_posti_pro_length_class_id'] = $this->config->get('shipping_posti_pro_length_class_id');
		}

		if (isset($this->request->post['shipping_posti_pro_tax_class_id'])) {
			$data['shipping_posti_pro_tax_class_id'] = $this->request->post['shipping_posti_pro_tax_class_id'];
		} else {
			$data['shipping_posti_pro_tax_class_id'] = $this->config->get('shipping_posti_pro_tax_class_id');
		}

		if (isset($this->request->post['shipping_posti_pro_free_cargo'])) {
			$data['shipping_posti_pro_free_cargo'] = $this->request->post['shipping_posti_pro_free_cargo'];
		} else {
			$data['shipping_posti_pro_free_cargo'] = $this->config->get('shipping_posti_pro_free_cargo');
		}

		if (isset($this->request->post['shipping_posti_pro_discount_cargo'])) {
			$data['shipping_posti_pro_discount_cargo'] = $this->request->post['shipping_posti_pro_discount_cargo'];
		} else {
			$data['shipping_posti_pro_discount_cargo'] = $this->config->get('shipping_posti_pro_discount_cargo');
		}

		if (isset($this->request->post['shipping_posti_pro_cargo_sum'])) {
			$data['shipping_posti_pro_cargo_sum'] = $this->request->post['shipping_posti_pro_cargo_sum'];
		} else {
			$data['shipping_posti_pro_cargo_sum'] = $this->config->get('shipping_posti_pro_cargo_sum');
		}

		if (isset($this->request->post['shipping_posti_pro_discount_cargo_percent'])) {
			$data['shipping_posti_pro_discount_cargo_percent'] = $this->request->post['shipping_posti_pro_discount_cargo_percent'];
		} else {
			$data['shipping_posti_pro_discount_cargo_percent'] = $this->config->get('shipping_posti_pro_discount_cargo_percent');
		}

		if (isset($this->request->post['shipping_posti_pro_discount_foreign_countries'])) {
			$data['shipping_posti_pro_discount_foreign_countries'] = $this->request->post['shipping_posti_pro_discount_foreign_countries'];
		} else {
			$data['shipping_posti_pro_discount_foreign_countries'] = $this->config->get('shipping_posti_pro_discount_foreign_countries');
		}

		if (isset($this->request->post['shipping_posti_pro_cargo_foreign_countries_sum'])) {
			$data['shipping_posti_pro_cargo_foreign_countries_sum'] = $this->request->post['shipping_posti_pro_cargo_foreign_countries_sum'];
		} else {
			$data['shipping_posti_pro_cargo_foreign_countries_sum'] = $this->config->get('shipping_posti_pro_cargo_foreign_countries_sum');
		}

		if (isset($this->request->post['shipping_posti_pro_discount_foreign_countries_percent'])) {
			$data['shipping_posti_pro_discount_foreign_countries_percent'] = $this->request->post['shipping_posti_pro_discount_foreign_countries_percent'];
		} else {
			$data['shipping_posti_pro_discount_foreign_countries_percent'] = $this->config->get('shipping_posti_pro_discount_foreign_countries_percent');
		}

		if (isset($this->request->post['shipping_posti_pro_hinnasto'])) {
			$data['shipping_posti_pro_hinnasto'] = $this->request->post['shipping_posti_pro_hinnasto'];
		} else {
			$data['shipping_posti_pro_hinnasto'] = $this->config->get('shipping_posti_pro_hinnasto');
		}
		...
		if (isset($this->request->post['shipping_posti_pro_hinnasto_countrygroup_1'])) {
			$data['shipping_posti_pro_hinnasto_countrygroup_1'] = $this->request->post['shipping_posti_pro_hinnasto_countrygroup_1'];
		} else {
			$data['shipping_posti_pro_hinnasto_countrygroup_1'] = $this->config->get('shipping_posti_pro_hinnasto_countrygroup_1');
		}

		if (isset($this->request->post['shipping_posti_pro_hinnasto_countrygroup_2'])) {
			$data['shipping_posti_pro_hinnasto_countrygroup_2'] = $this->request->post['shipping_posti_pro_hinnasto_countrygroup_2'];
		} else {
			$data['shipping_posti_pro_hinnasto_countrygroup_2'] = $this->config->get('shipping_posti_pro_hinnasto_countrygroup_2');
		}

		if (isset($this->request->post['shipping_posti_pro_hinnasto_countrygroup_3'])) {
			$data['shipping_posti_pro_hinnasto_countrygroup_3'] = $this->request->post['shipping_posti_pro_hinnasto_countrygroup_3'];
		} else {
			$data['shipping_posti_pro_hinnasto_countrygroup_3'] = $this->config->get('shipping_posti_pro_hinnasto_countrygroup_3');
		}

		if (isset($this->request->post['shipping_posti_pro_hinnasto_countrygroup_4'])) {
			$data['shipping_posti_pro_hinnasto_countrygroup_4'] = $this->request->post['shipping_posti_pro_hinnasto_countrygroup_4'];
		} else {
			$data['shipping_posti_pro_hinnasto_countrygroup_4'] = $this->config->get('shipping_posti_pro_hinnasto_countrygroup_4');
		}


		if (isset($this->error['shipping_posti_pro_hinnasto'])) {
			foreach($this->error['shipping_posti_pro_hinnasto'] as $key=>$hinnasto){
			   	  $data['shipping_posti_pro_hinnasto'][$key]['error'] = $this->language->get('error_decimale_point');
			}
		}

		if (isset($this->error['shipping_posti_pro_hinnasto_countrygroup_1'])) {
			foreach($this->error['shipping_posti_pro_hinnasto_countrygroup_1'] as $key=>$hinnasto){
			   	  $data['shipping_posti_pro_hinnasto_countrygroup_1'][$key]['error'] = $this->language->get('error_decimale_point');
			}
		}

		if (isset($this->error['shipping_posti_pro_hinnasto_countrygroup_2'])) {
			foreach($this->error['shipping_posti_pro_hinnasto_countrygroup_2'] as $key=>$hinnasto){
			   	  $data['shipping_posti_pro_hinnasto_countrygroup_2'][$key]['error'] = $this->language->get('error_decimale_point');
			}
		}

		if (isset($this->error['shipping_posti_pro_hinnasto_countrygroup_3'])) {
			foreach($this->error['shipping_posti_pro_hinnasto_countrygroup_3'] as $key=>$hinnasto){
			   	  $data['shipping_posti_pro_hinnasto_countrygroup_3'][$key]['error'] = $this->language->get('error_decimale_point');
			}
		}

		if (isset($this->error['shipping_posti_pro_hinnasto_countrygroup_4'])) {
			foreach($this->error['shipping_posti_pro_hinnasto_countrygroup_4'] as $key=>$hinnasto){
			   	  $data['shipping_posti_pro_hinnasto_countrygroup_4'][$key]['error'] = $this->language->get('error_decimale_point');
			}
		}
		...
		if (isset($this->request->post['shipping_posti_pro_geo_zone_id'])) {
			$data['shipping_posti_pro_geo_zone_id'] = $this->request->post['shipping_posti_pro_geo_zone_id'];
		} else {
			$data['shipping_posti_pro_geo_zone_id'] = $this->config->get('shipping_posti_pro_geo_zone_id');
		}
		...
		$this->response->setOutput($this->load->view('extension/shipping/posti_pro', $data));
	}
	...
	public function install(){
        ...
        (0, 'shipping_posti_pro', 'shipping_posti_pro_hinnasto', '[{\"kg\":\"2\",\"price\":\"8.90\"},{\"kg\":\"5\",\"price\":\"10.90\"},{\"kg\":\"10\",\"price\":\"11.90\"},{\"kg\":\"15\",\"price\":\"14.90\"},{\"kg\":\"35\",\"price\":\"20.90\"}]', 1),
        (0, 'shipping_posti_pro', 'shipping_posti_pro_hinnasto_countrygroup_1', '[{\"kg\":\"2\",\"price\":\"29\"},{\"kg\":\"5\",\"price\":\"33\"},{\"kg\":\"10\",\"price\":\"39\"},{\"kg\":\"15\",\"price\":\"51\"},{\"kg\":\"30\",\"price\":\"74\"}]', 1),
        (0, 'shipping_posti_pro', 'shipping_posti_pro_hinnasto_countrygroup_3', '[{\"kg\":\"2\",\"price\":\"46\"},{\"kg\":\"5\",\"price\":\"60\"},{\"kg\":\"10\",\"price\":\"82\"},{\"kg\":\"15\",\"price\":\"94\"},{\"kg\":\"30\",\"price\":\"152\"}]', 1),
        (0, 'shipping_posti_pro', 'shipping_posti_pro_hinnasto_countrygroup_4', '[{\"kg\":\"2\",\"price\":\"47\"},{\"kg\":\"5\",\"price\":\"61\"},{\"kg\":\"10\",\"price\":\"93\"},{\"kg\":\"15\",\"price\":\"111\"},{\"kg\":\"30\",\"price\":\"196\"}]', 1),
        (0, 'shipping_posti_pro', 'shipping_posti_pro_hinnasto_countrygroup_2', '[{\"kg\":\"2\",\"price\":\"33\"},{\"kg\":\"5\",\"price\":\"44\"},{\"kg\":\"10\",\"price\":\"57\"},{\"kg\":\"15\",\"price\":\"76\"},{\"kg\":\"30\",\"price\":\"119\"}]', 1)");
	}

	protected function validate() {
		if (!$this->user->hasPermission('modify', 'extension/shipping/posti_pro')) {
			$this->error['warning'] = $this->language->get('error_permission');
		}
		if($this->request->post['shipping_posti_pro_hinnasto']){
			foreach($this->request->post['shipping_posti_pro_hinnasto'] as $key=>$hinnasto){
			   if(strpos($hinnasto['price'],',')){
			      $this->error['warning'] = $this->language->get('error_warning');
			   	  $this->error['shipping_posti_pro_hinnasto'][$key]['error'] = $this->language->get('error_decimale_point');
			   }
			}
		}
		if($this->request->post['shipping_posti_pro_hinnasto_countrygroup_1']){
			foreach($this->request->post['shipping_posti_pro_hinnasto_countrygroup_1'] as $key=>$hinnasto){
			   if(strpos($hinnasto['price'],',')){
			      $this->error['warning'] = $this->language->get('error_warning');
			   	  $this->error['shipping_posti_pro_hinnasto_countrygroup_1'][$key]['error'] = $this->language->get('error_decimale_point');
			   }
			}
		}
		if($this->request->post['shipping_posti_pro_hinnasto_countrygroup_2']){
			foreach($this->request->post['shipping_posti_pro_hinnasto_countrygroup_2'] as $key=>$hinnasto){
			   if(strpos($hinnasto['price'],',')){
			      $this->error['warning'] = $this->language->get('error_warning');
			   	  $this->error['shipping_posti_pro_hinnasto_countrygroup_2'][$key]['error'] = $this->language->get('error_decimale_point');
			   }
			}
		}
		if($this->request->post['shipping_posti_pro_hinnasto_countrygroup_3']){
			foreach($this->request->post['shipping_posti_pro_hinnasto_countrygroup_3'] as $key=>$hinnasto){
			   if(strpos($hinnasto['price'],',')){
			      $this->error['warning'] = $this->language->get('error_warning');
			   	  $this->error['shipping_posti_pro_hinnasto_countrygroup_3'][$key]['error'] = $this->language->get('error_decimale_point');
			   }
			}
		}
		if($this->request->post['shipping_posti_pro_hinnasto_countrygroup_4']){
			foreach($this->request->post['shipping_posti_pro_hinnasto_countrygroup_4'] as $key=>$hinnasto){
			   if(strpos($hinnasto['price'],',')){
			      $this->error['warning'] = $this->language->get('error_warning');
			   	  $this->error['shipping_posti_pro_hinnasto_countrygroup_4'][$key]['error'] = $this->language->get('error_decimale_point');
			   }
			}
		}
