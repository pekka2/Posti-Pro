      ...
      <div class="panel-body">
        <form action="<?php echo $action ?>" method="post" enctype="multipart/form-data" id="form-shipping" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-hinnasto1" data-toggle="tab"><?php echo $tab_hinnasto_2 ?></a></li>
            <li><a href="#tab-hinnasto2" data-toggle="tab"><?php echo $tab_hinnasto_3 ?></a></li>
            <li><a href="#tab-hinnasto3" data-toggle="tab"><?php echo $tab_hinnasto_4 ?></a></li>
            <li><a href="#tab-hinnasto4" data-toggle="tab"><?php echo $tab_hinnasto_5 ?></a></li>
          </ul>
